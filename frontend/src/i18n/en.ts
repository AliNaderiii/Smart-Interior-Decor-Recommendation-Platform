...
export const en: Dict = {
  ...
  recommendations: {
    ...
    scoreFit: "Room fit",
    fitReason: {
      fit_ok: "Fits your room comfortably",
      fit_tight: "Tight for your room",
      fit_too_big: "Too big for your room",
      fit_too_small: "Small for your room",
      fit_too_tall: "Taller than a standard ceiling",
      fit_unknown: "Size not compared — dimensions missing",
      fit_neutral: "Size not a factor for this category",
    } as Record<string, string>,
    fitBadgeTooBig: "Won't fit",
    fitBadgeTight: "Tight fit",
    fitBadgeSmall: "Small for room",
    fitDims: (w: string, d: string) => `${w} × ${d} cm`,
    palette: "Palette",
  ...
  visualSearch: {
    title: "Visual search",
    subtitle:
      "Drop a photo of a sofa, a rug or a room you love — we find the closest pieces in the catalogue. The photo is not stored.",
    dropTitle: "Drop a photo here or choose one",
    dropHint: "JPEG, PNG or WebP — up to 8 MB",
    chooseFile: "Choose photo",
    changePhoto: "Another photo",
    searching: "Searching…",
    searchCta: "Find similar",
    categoryAll: "All categories",
    categoryLabel: "Limit to category",
    resultsTitle: (n: number) => `${n} similar product${n === 1 ? "" : "s"}`,
    similarity: (pct: string) => `${pct}% similar`,
    paletteTitle: "Dominant colours in your photo",
    usePalette: "Use these colours in the style quiz",
    paletteApplied: "Colours added to your style quiz.",
    modePalette:
      "Colour mode: the CLIP model is not active in this environment, so results are ranked by how closely the photo's dominant colours match each product's colours.",
    modeClip: "Vision mode: CLIP similarity on shape and style, plus colour agreement.",
    privacy: "The photo is processed in memory only and never stored.",
    emptyTitle: "No similar products found",
    emptyHint: "Try another photo, or remove the category limit.",
    errorTitle: "Search failed",
    tooLarge: "The photo is larger than 8 MB.",
    notImage: "That file is not an image.",
    rateLimited: "Too many searches — try again in a minute.",
    lockedHint: "Upgrade to Pro to see every result",
    addToMoodboard: "Add to moodboard",
    added: "Added",
    previewAlt: "Photo selected for the search",
  },
  moodboards: {
    title: "Moodboards",
