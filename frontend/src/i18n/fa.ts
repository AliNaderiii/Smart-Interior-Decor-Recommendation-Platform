...
export const fa = {
  ...
  proof: {
    title: "کاربران چه می‌گویند",
    subtitle: "سه نقش متفاوت، سه استفاده متفاوت.",
    items: [
      {
        quote:
          "قبل از خرید مبل، سه ترکیب مختلف را دیدم و فهمیدم کدام با فرش خانه‌مان جور است. پول اشتباه ندادم.",
        role: "صاحب‌خانه، تهران",
      },
      {
        quote:
          "برای هر مشتری در چند دقیقه چند گزینه آماده می‌کنم، به‌جای اینکه دو روز مودبورد بسازم.",
        role: "طراح داخلی",
      },
      {
        quote:
          "امتیاز تفکیک‌شده مهم‌ترین بخش است؛ می‌توانم به مشتری توضیح بدهم چرا این گزینه پیشنهاد شده.",
        role: "مشاور چیدمان",
      },
    ],
  },
