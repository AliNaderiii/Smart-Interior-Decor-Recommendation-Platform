...
export const fa = {
  ...
  recommendations: {
    ...
    scoreFit: "تناسب با اتاق",
    fitReason: {
      fit_ok: "به‌راحتی در اتاق شما جا می‌شود",
      fit_tight: "برای اتاق شما کمی بزرگ است",
      fit_too_big: "در اتاق شما جا نمی‌شود",
      fit_too_small: "برای اتاق شما کوچک است",
      fit_too_tall: "بلندتر از سقف استاندارد",
      fit_unknown: "ابعاد مقایسه نشد — اندازه‌ها ثبت نشده",
      fit_neutral: "اندازه برای این دسته تعیین‌کننده نیست",
    } as Record<string, string>,
    fitBadgeTooBig: "جا نمی‌شود",
    fitBadgeTight: "کمی بزرگ",
    fitBadgeSmall: "کوچک برای اتاق",
    fitDims: (w: string, d: string) => `${w} × ${d} سانتی‌متر`,
    palette: "پالت",
  ...
  /** ADR-013 — visual search ("find what looks like this photo"). */
  roomPhoto: {
    title: "عکس اتاقت را بده، بقیه با ما",
    subtitle:
      "یک عکس از نشیمن فعلی‌ات بفرست؛ سبک، متریال و رنگ‌های غالب را تشخیص می‌دهیم و آزمون را از پیش پر می‌کنیم. هر چیزی را می‌توانی عوض کنی.",
    cta: "انتخاب عکس اتاق",
    analyzing: "در حال تحلیل عکس…",
    skip: "بدون عکس ادامه می‌دهم",
    privacy: "عکس فقط در حافظه پردازش می‌شود و ذخیره نمی‌شود.",
    tierConfident: "تشخیص با اطمینان بالا — گزینه‌ها از پیش انتخاب شدند.",
    tierSuggested: "تشخیص نامطمئن — پیشنهادها را انتخاب کردیم؛ لطفاً بازبینی کن.",
    tierPaletteOnly:
      "در این محیط مدل بینایی فعال نیست؛ فقط رنگ‌های غالب عکس به آزمون اضافه شد. سبک و متریال را خودت انتخاب کن.",
    detected: "چیزی که دیدیم",
    styles: "سبک",
    materials: "متریال",
    colors: "رنگ‌های غالب",
    noneDetected: "—",
    confidence: (pct: string) => `اطمینان ${pct}٪`,
    heuristicBadge: "حالت آزمایشی (بدون مدل بینایی)",
    dimensionsNote: "ابعاد اتاق از روی عکس تخمین زده نمی‌شود — در مرحله ۳ خودت وارد کن.",
    applied: "آزمون از روی عکس اتاق پر شد. هر مرحله را می‌توانی تغییر دهی.",
    retry: "عکس دیگر",
    errorTitle: "تحلیل عکس ممکن نشد",
    tooLarge: "حجم عکس بیشتر از ۸ مگابایت است.",
    notImage: "این فایل تصویر نیست.",
    rateLimited: "تعداد تحلیل زیاد بود؛ یک دقیقه بعد دوباره امتحان کنید.",
    previewAlt: "عکس اتاق انتخاب‌شده",
    prefilledBadge: "پر شده از روی عکس",
  },
  visualSearch: {
    title: "جست‌وجوی تصویری",
    subtitle:
      "عکس یک مبل، فرش یا اتاقی که دوست دارید را بدهید؛ نزدیک‌ترین محصولات کاتالوگ را پیدا می‌کنیم. عکس ذخیره نمی‌شود.",
    dropTitle: "عکس را اینجا رها کنید یا انتخاب کنید",
    dropHint: "JPEG، PNG یا WebP — تا ۸ مگابایت",
    chooseFile: "انتخاب عکس",
    changePhoto: "عکس دیگر",
    searching: "در حال جست‌وجو…",
    searchCta: "پیدا کن",
    categoryAll: "همه دسته‌ها",
    categoryLabel: "محدود به دسته",
    resultsTitle: (n: number) => `${n} محصول مشابه`,
    similarity: (pct: string) => `${pct}٪ شباهت`,
    paletteTitle: "رنگ‌های غالب عکس",
    usePalette: "استفاده از این رنگ‌ها در آزمون سبک",
    paletteApplied: "رنگ‌ها به آزمون سبک اضافه شد.",
    modePalette:
      "حالت رنگ‌محور: در این محیط مدل CLIP فعال نیست؛ نتایج بر اساس شباهت رنگ‌های غالب عکس با رنگ محصولات رتبه‌بندی شده‌اند.",
    modeClip: "حالت بینایی: شباهت با CLIP روی شکل و سبک، به‌همراه هم‌خوانی رنگ.",
    privacy: "عکس فقط در حافظه پردازش می‌شود و هیچ‌جا ذخیره نمی‌شود.",
    emptyTitle: "محصول مشابهی پیدا نشد",
    emptyHint: "عکس دیگری امتحان کنید یا محدودیت دسته را بردارید.",
    errorTitle: "جست‌وجو ممکن نشد",
    tooLarge: "حجم عکس بیشتر از ۸ مگابایت است.",
    notImage: "این فایل تصویر نیست.",
    rateLimited: "تعداد جست‌وجو زیاد بود؛ یک دقیقه بعد دوباره امتحان کنید.",
    lockedHint: "برای دیدن همه‌ی نتایج به Pro ارتقا دهید",
    addToMoodboard: "افزودن به مودبورد",
    added: "افزوده شد",
    previewAlt: "عکس انتخاب‌شده برای جست‌وجو",
  },
  moodboards: {
    title: "مودبوردها",
  ...
  admin: {
    ...
    /** P4-ب·2f: خارج‌کردن یک ردیف تأییدشده از پیشنهادها. */
    unverify: "لغو تأیید",
    unverifyConfirm: (title: string) =>
      `«${title}» از پیشنهادها خارج شود؟ ردیف حذف نمی‌شود، به صف بازبینی برمی‌گردد و این تصمیم در لاگ ممیزی ثبت می‌شود.`,
    unverified: "از پیشنهادها خارج شد و به صف بازبینی برگشت.",
    unverifyFailed: "لغو تأیید انجام نشد.",
    integrityReasons: {
